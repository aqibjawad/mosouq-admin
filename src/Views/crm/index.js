                    ...
                    <Card className="mt-3">
                        <Card.Body>
                            <Nav className="flex-column">
                                <Nav.Link as={Link} to="/settings/profile">Business Profiles</Nav.Link>
                                <Nav.Link as={Link} to="/settings/account">Business Pricing</Nav.Link>
                                <Nav.Link as={Link} to="/settings/security">Business Logo</Nav.Link>
